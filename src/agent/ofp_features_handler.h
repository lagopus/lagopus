...
/**
 * @file	ofp_features_handler.h
 */

#ifndef __OFP_FEATURES_HANDLER_H__
#define __OFP_FEATURES_HANDLER_H__

#include "ofp_common.h"
#include "channel.h"

/**
 * ofp_features_request handler.
 *
 ...
 */
lagopus_result_t
ofp_features_reply_create(struct channel *channel, struct pbuf **pbuf,
                          struct ofp_header *xid_header);
#endif /* __UNIT_TESTING__ */

#endif /* __OFP_FEATURES_HANDLER_H__ */
