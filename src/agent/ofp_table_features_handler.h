...
/**
 * @file	ofp_table_features_handler.h
 */

#ifndef __OFP_TABLE_FEATURES_HANDLER_H__
#define __OFP_TABLE_FEATURES_HANDLER_H__

#include "ofp_common.h"

/**
 * Free table_features_list elements.
 *
 *     @param[in]	table_features_list	A pointer to list of
 *     \e table_features structures.
 *
 *     @retval	void
 */
void
table_features_list_elem_free(struct table_features_list *table_features_list);

/**
 * ofp_table_features_request handler.
 *
...
/**
 * Create ofp_table_features_reply.
 *
 *     @param[in]	channel	A pointer to \e channel structure.
...
#endif /* __OFP_TABLE_FEATURES_HANDLER_H__ */
