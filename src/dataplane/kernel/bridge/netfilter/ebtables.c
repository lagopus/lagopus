...
static inline int
ebt_cleanup_match(struct ebt_entry_match *m, struct net *net,
                  unsigned int *i) {
...
static inline int
ebt_cleanup_watcher(struct ebt_entry_watcher *w, struct net *net,
                    unsigned int *i) {
...
static int translate_table(struct net *net, const char *name,
  ...
  /* we now know the following (along with E=mc族):
...
static int ebt_buf_count(struct ebt_entries_buf_state *state,
                         unsigned int sz) {
