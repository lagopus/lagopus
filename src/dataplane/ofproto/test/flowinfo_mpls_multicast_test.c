...
#define ETHER_TYPE_MPLS_UT ETHER_TYPE_MPLS_MCAST
...
void
test_flowinfo_mpls_multicast_label_adddel(void) {
  size_t s;
...
void
test_flowinfo_mpls_multicast_tc_adddel(void) {
  size_t s;
...
void
test_flowinfo_mpls_multicast_bos_adddel(void) {
  size_t s;
