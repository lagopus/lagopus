...
/**
 * @file	affinition_cmd_internal.h
 */

#ifndef __AFFINITION_CMD_INTERNAL_H__
#define __AFFINITION_CMD_INTERNAL_H__

#include "cmd_common.h"

/**
 * Parse command for affinition.
 *
...
#endif /* __AFFINITION_CMD_INTERNAL_H__ */
