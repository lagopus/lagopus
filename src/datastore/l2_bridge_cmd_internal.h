...
/**
 * @file	l2_bridge_cmd_internal.h
 */

#ifndef __L2_BRIDGE_CMD_INTERNAL_H__
#define __L2_BRIDGE_CMD_INTERNAL_H__

#include "cmd_common.h"

/**
 * Parse command for l2_bridge.
 *
...
/**
 * Update l2_bridge obj.
 *
 *     @param[in]	iptr	An interpreter.
 *     @paran[in]	state	A status of the interpreter.
 *     @param[in]	objc	A pointer to a l2_bridge obj.
 *     @param[out]	result	A result/output string.
 *
 *     @retval	LAGOPUS_RESULT_OK	Succeeded.
 *     @retval	LAGOPUS_RESULT_ANY_FAILURES	Failed.
...
#endif /* __L2_BRIDGE_CMD_INTERNAL_H__ */
