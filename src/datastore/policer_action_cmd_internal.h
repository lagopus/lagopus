...
/**
 * @file	policer_action_cmd_internal.h
 */

#ifndef __POLICER_ACTION_CMD_INTERNAL_H__
#define __POLICER_ACTION_CMD_INTERNAL_H__

#include "cmd_common.h"

/**
 * Parse command for policer_action.
 *
...
/**
 * Update policer_action obj.
 *
 *     @param[in]	iptr	An interpreter.
 *     @paran[in]	state	A status of the interpreter.
 *     @param[in]	objc	A pointer to a policer_action obj.
 *     @param[out]	result	A result/output string.
 *
 *     @retval	LAGOPUS_RESULT_OK	Succeeded.
 *     @retval	LAGOPUS_RESULT_ANY_FAILURES	Failed.
...
#endif /* __POLICER_ACTION_CMD_INTERNAL_H__ */
