...
test_port_cmd_parse_create_01(void) {
  ...
  const char test_str3[] =
    ...
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth\\\"1\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p1_2\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q1_2\",\""NAMESPACE_DELIMITER"q1_3\"],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":true},\n"
    "{\"name\":\""NAMESPACE_DELIMITER"test_name01\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth0\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p1_1\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q1_1\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char inter_test_str2[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_eth\\\"1\",\n"
    "\"type\":\"ethernet-rawsock\",\n"
    "\"port-number\":100,\n"
    "\"device\":\"eth0\",\n"
    "\"mtu\":1500,\n"
  ...
  const char *queue_argv1[] = {"queue", "q1_2", NULL};
  const char queue_test_str1[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"q1_2\",\n"
    "\"type\":\"single-rate\",\n"
    "\"id\":2,\n"
    "\"priority\":0,\n"
    "\"color\":\"color-aware\",\n"
    ...
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  const char *queue_argv2[] = {"queue", "q1_3", NULL};
  const char queue_test_str2[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"q1_3\",\n"
    "\"type\":\"single-rate\",\n"
    "\"id\":3,\n"
    "\"priority\":0,\n"
    "\"color\":\"color-aware\",\n"
    ...
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  const char *queue_argv3[] = {"queue", "q1_2", NULL};
  const char queue_test_str3[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"q1_2\",\n"
    "\"type\":\"single-rate\",\n"
    "\"id\":2,\n"
    ...
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  const char *queue_argv4[] = {"queue", "q1_3", NULL};
  const char queue_test_str4[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"q1_3\",\n"
    "\"type\":\"single-rate\",\n"
    "\"id\":3,\n"
  ...
  const char policer_test_str1[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"p1_2\",\n"
    "\"actions\":[\""NAMESPACE_DELIMITER"pa1_2\"],\n"
  ...
  TEST_QUEUE_CREATE(ret, &interp, state, &tbl, &ds, str, "q1_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state, &tbl, &ds, str, "q1_2", "2");
  TEST_QUEUE_CREATE(ret, &interp, state, &tbl, &ds, str, "q1_3", "3");
  ...
  TEST_CMD_PARSE(ret, LAGOPUS_RESULT_OK, queue_cmd_parse, &interp, state,
                 ARGV_SIZE(queue_argv1), queue_argv1, &tbl, queue_cmd_update,
                 &ds, str, queue_test_str1);

  /* queue show cmd. */
  TEST_CMD_PARSE(ret, LAGOPUS_RESULT_OK, queue_cmd_parse, &interp, state,
                 ARGV_SIZE(queue_argv2), queue_argv2, &tbl, queue_cmd_update,
                 &ds, str, queue_test_str2);
  ...
  /* queue show cmd. */
  TEST_CMD_PARSE(ret, LAGOPUS_RESULT_OK, queue_cmd_parse, &interp, state,
                 ARGV_SIZE(queue_argv3), queue_argv3, &tbl, queue_cmd_update,
                 &ds, str, queue_test_str3);

  /* queue show cmd. */
  TEST_CMD_PARSE(ret, LAGOPUS_RESULT_OK, queue_cmd_parse, &interp, state,
                 ARGV_SIZE(queue_argv4), queue_argv4, &tbl, queue_cmd_update,
                 &ds, str, queue_test_str4);
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state, &tbl, &ds, str, "q1_1");
  TEST_QUEUE_DESTROY(ret, &interp, state, &tbl, &ds, str, "q1_2");
  TEST_QUEUE_DESTROY(ret, &interp, state, &tbl, &ds, str, "q1_3");
...
test_port_cmd_parse_enable_unused(void) {
  ...
  const char test_str2[] =
    "{\"ret\":\"NOT_OPERATIONAL\",\n"
    "\"data\":\"name = "NAMESPACE_DELIMITER"test_name08. is not used.\"}";
  const char *argv3[] = {"port", "test_name08", NULL};
  const char test_str3[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name08\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth2\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
...
test_port_cmd_parse_create_not_exists(void) {
  ...
  const char test_str1[] =
    "{\"ret\":\"NOT_FOUND\",\n"
    "\"data\":\"interface name = "NAMESPACE_DELIMITER"test_eth100.\"}";
...
test_port_cmd_parse_config_01(void) {
  ...
  const char test_str2[] =
    ...
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth3\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str4[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name10\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth4\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char inter_test_str2[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_eth3\",\n"
    "\"type\":\"ethernet-rawsock\",\n"
    "\"port-number\":103,\n"
    "\"device\":\"eth0\",\n"
    "\"mtu\":1500,\n"
  ...
  const char inter_test_str5[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_eth4\",\n"
    "\"type\":\"ethernet-rawsock\",\n"
    "\"port-number\":104,\n"
    "\"device\":\"eth1\",\n"
    "\"mtu\":1500,\n"
...
test_port_cmd_parse_config_02(void) {
  ...
  const char test_str3[] =
    ...
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth5\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  ...
  const char test_str5[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name11\",\n"
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth6\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
...
test_port_cmd_parse_config_show_01(void) {
  ...
  const char test_str2[] =
    ...
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth7\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str4[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name12\",\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth8\"}]}";
...
test_port_cmd_parse_show_01(void) {
  ...
  const char test_str2[] =
    ...
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth9\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str7[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name14\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth11\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
...
test_port_cmd_serialize_01(void) {
  ...
  const char serialize_str1[] =
    "port "NAMESPACE_DELIMITER"test_name15 create "
    "-interface "NAMESPACE_DELIMITER"test_eth15 "
    "-policer "NAMESPACE_DELIMITER"p15_1 "
    "-queue "NAMESPACE_DELIMITER"q15_1 "
    "-queue "NAMESPACE_DELIMITER"q15_2\n";
  ...
  TEST_QUEUE_CREATE(ret, &interp, state, &tbl, &ds, str, "q15_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state, &tbl, &ds, str, "q15_2", "2");
  ...
  TEST_CMD_PROC(ret, LAGOPUS_RESULT_OK, port_cmd_serialize, &interp, state, &tbl,
                NAMESPACE_DELIMITER"test_name15", conf, &ds, str, serialize_str1);
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state, &tbl, &ds, str, "q15_1");
  TEST_QUEUE_DESTROY(ret, &interp, state, &tbl, &ds, str, "q15_2");
...
test_port_cmd_serialize_escape(void) {
  ...
  void *conf = NULL;
  const char serialize_str1[] =
    "port \""NAMESPACE_DELIMITER"test_\\\"name16\" create "
    "-interface \""NAMESPACE_DELIMITER"test_\\\"eth16\"\n";
  ...
  /* TEST : serialize. */
  TEST_CMD_PROC(ret, LAGOPUS_RESULT_OK, port_cmd_serialize, &interp, state, &tbl,
                NAMESPACE_DELIMITER"test_\"name16", conf, &ds, str, serialize_str1);
...
test_port_cmd_serialize_escape_white_space(void) {
  ...
  void *conf = NULL;
  const char serialize_str1[] =
    "port \""NAMESPACE_DELIMITER"test name17\" create "
    "-interface \""NAMESPACE_DELIMITER"test eth17\"\n";
  ...
  /* TEST : serialize. */
  TEST_CMD_PROC(ret, LAGOPUS_RESULT_OK, port_cmd_serialize, &interp, state, &tbl,
                NAMESPACE_DELIMITER"test name17", conf, &ds, str, serialize_str1);
...
test_port_cmd_serialize_none_opts(void) {
  ...
  void *conf = NULL;
  const char serialize_str1[] =
    "port "NAMESPACE_DELIMITER"test_name18 create\n";
  ...
  /* TEST : serialize. */
  TEST_CMD_PROC(ret, LAGOPUS_RESULT_OK, port_cmd_serialize, &interp, state, &tbl,
                NAMESPACE_DELIMITER"test_name18", conf, &ds, str, serialize_str1);
...
test_port_cmd_parse_atomic_commit(void) {
  ...
  const char test_str3[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name19\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth19\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p19_1\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q19_1\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str6[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name19\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth19_2\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p19_2\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q19_1\",\""NAMESPACE_DELIMITER"q19_2\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q19_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q19_2", "2");
  ...
  TEST_PROC(ret, LAGOPUS_RESULT_OK, port_cmd_update, &interp, state2, &tbl,
            NAMESPACE_DELIMITER"test_name19", conf, &ds);
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q19_1");
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q19_2");
...
test_port_cmd_parse_atomic_rollback(void) {
  ...
  const char test_str3[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name20\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth20\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p20_1\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q20_1\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str6[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name20\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth20_2\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p20_2\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q20_1\",\""NAMESPACE_DELIMITER"q20_2\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q20_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q20_2", "2");
  ...
  /* rollbacking. */
  TEST_PROC(ret, LAGOPUS_RESULT_OK, port_cmd_update, &interp, state2, &tbl,
            NAMESPACE_DELIMITER"test_name20", conf, &ds);
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q20_1");
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q20_2");
...
test_port_cmd_parse_atomic_delay_enable(void) {
  ...
  const char test_str4[] =
    ...
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth21\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":false}]}";
...
test_port_cmd_parse_atomic_delay_disable(void) {
  ...
  const char test_str4[] =
    ...
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth22\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
...
test_port_cmd_parse_atomic_abort_01(void) {
  ...
  const char test_str3[] =
    ...
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth24\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p24_1\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q24_1\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str6[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name24\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth24_2\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p24_2\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q24_1\",\""NAMESPACE_DELIMITER"q24_2\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q24_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q24_2", "2");
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q24_1");
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q24_2");
...
test_port_cmd_parse_atomic_abort_02(void) {
  ...
  const char test_str2[] =
    ...
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth25\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p25_1\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q25_1\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str6[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name25\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth25_2\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p25_2\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q25_1\",\""NAMESPACE_DELIMITER"q25_2\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q25_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q25_2", "2");
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q25_1");
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q25_2");
...
test_port_cmd_parse_atomic_destroy_create(void) {
  ...
  const char test_str5[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name26\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth26\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p26_1\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q26_1\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  const char test_str6[] =
    ...
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name26\",\n"
    "\"port-number\":0,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth26_2\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p26_2\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q26_1\",\""NAMESPACE_DELIMITER"q26_2\"],\n"
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  ...
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q26_1", "1");
  TEST_QUEUE_CREATE(ret, &interp, state4, &tbl, &ds, str, "q26_2", "2");
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q26_1");
  TEST_QUEUE_DESTROY(ret, &interp, state4, &tbl, &ds, str, "q26_2");
...
test_port_cmd_parse_create_bad_queue_name_val(void) {
  ...
  const char test_str[] =
    "{\"ret\":\"NOT_FOUND\",\n"
    "\"data\":\"queue name = "NAMESPACE_DELIMITER"hoge.\"}";
...
void
test_port_cmd_parse_config_delete_queue(void) {
  lagopus_result_t ret = LAGOPUS_RESULT_ANY_FAILURES;
  datastore_interp_state_t state = DATASTORE_INTERP_STATE_AUTO_COMMIT;
  char *str = NULL;
  const char *argv1[] = {"port", "test_name30", "create",
                         "-interface", "test_eth30",
                         "-queue", "+q30_1",
                         NULL
                        };
  const char test_str1[] = "{\"ret\":\"OK\"}";
  const char *argv2[] = {"port", "test_name30", "enable",
                         NULL
                        };
  const char test_str2[] = "{\"ret\":\"OK\"}";
  const char *argv3[] = {"port", "test_name30", NULL};
  const char test_str3[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name30\",\n"
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth30\",\n"
    "\"policer\":\"\",\n"
    "\"queues\":[\""NAMESPACE_DELIMITER"q30_1\"],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  const char *argv4[] = {"port", "test_name30", "config",
                         "-queue", "~q30_1",
                         NULL
                        };
  const char test_str4[] = "{\"ret\":\"OK\"}";
  const char *argv5[] = {"port", "test_name30", NULL};
  const char test_str5[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"test_name30\",\n"
    "\"port-number\":65535,\n"
    ...
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  const char *argv6[] = {"port", "test_name30", "disable",
                         NULL
                        };
  const char test_str6[] = "{\"ret\":\"OK\"}";
  const char *argv7[] = {"port", "test_name30", "destroy",
                         NULL
                        };
  const char test_str7[] = "{\"ret\":\"OK\"}";
  ...
  const char inter_test_str1[] = "{\"ret\":\"OK\"}";
  const char *inter_argv2[] = {"interface", "test_eth30", "destroy",
                               NULL
                              };
  const char inter_test_str2[] = "{\"ret\":\"OK\"}";
  const char *queue_argv1[] = {"queue", "q30_1", NULL};
  const char queue_test_str1[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"q30_1\",\n"
    "\"type\":\"single-rate\",\n"
    "\"id\":30,\n"
    "\"priority\":0,\n"
    "\"color\":\"color-aware\",\n"
    ...
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  const char *queue_argv2[] = {"queue", "q30_1", NULL};
  const char queue_test_str2[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"q30_1\",\n"
    "\"type\":\"single-rate\",\n"
    ...
    "\"is-used\":false,\n"
    "\"is-enabled\":false}]}";
  const char *bridge_argv1[] = {"bridge", "test_bridge30", "create",
                                "-port", "test_name30", "65535",
                                NULL
                               };
  const char bridge_test_str1[] = "{\"ret\":\"OK\"}";
  const char *bridge_argv2[] = {"bridge", "test_bridge30", "destroy",
                                NULL
                               };
  const char bridge_test_str2[] = "{\"ret\":\"OK\"}";

  TEST_QUEUE_CREATE(ret, &interp, state, &tbl, &ds, str, "q30_1", "30");
  ...
  TEST_QUEUE_DESTROY(ret, &interp, state, &tbl, &ds, str, "q30_1");
}
...
test_port_cmd_parse_create_bad_policer_name_val(void) {
  ...
  const char test_str[] =
    "{\"ret\":\"NOT_FOUND\",\n"
    "\"data\":\"policer name = "NAMESPACE_DELIMITER"hoge.\"}";
...
test_port_cmd_parse_config_delete_policer(void) {
  ...
  const char test_str3[] =
    ...
    "\"port-number\":65535,\n"
    "\"interface\":\""NAMESPACE_DELIMITER"test_eth33\",\n"
    "\"policer\":\""NAMESPACE_DELIMITER"p33_1\",\n"
    "\"queues\":[],\n"
    "\"is-used\":true,\n"
    "\"is-enabled\":true}]}";
  ...
  const char policer_test_str1[] =
    "{\"ret\":\"OK\",\n"
    "\"data\":[{\"name\":\""NAMESPACE_DELIMITER"p33_1\",\n"
    "\"actions\":[\""NAMESPACE_DELIMITER"pa33_1\"],\n"
    "\"bandwidth-limit\":1500,\n"
    "\"burst-size-limit\":1500,\n"
    "\"bandwidth-percent\":0,\n"
    "\"is-used\":true,\n"
