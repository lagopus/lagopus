...
class TunnelGre(RyuApp):
    ...
    def install_flow_encap(self, datapath, ofp, ofp_parser):
        ...
        actions = [ofp_parser.OFPActionEncap(131119),
                   ofp_parser.OFPActionSetField(gre_key=1),
    ...
    def install_flow_decap(self, datapath, ofp, ofp_parser):
        ...
        actions = [ofp_parser.OFPActionDecap(cur_pkt_type=0, new_pkt_type=67584),
                   ofp_parser.OFPActionDecap(cur_pkt_type=67584, new_pkt_type=131119),
                   ofp_parser.OFPActionDecap(cur_pkt_type=131119, new_pkt_type=0),
                   ofp_parser.OFPActionOutput(2)]
        inst = [ofp_parser.OFPInstructionActions(ofp.OFPIT_APPLY_ACTIONS,
                                                 actions)]
        req = ofp_parser.OFPFlowMod(datapath, cookie, cookie_mask,
